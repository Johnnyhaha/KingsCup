...
var classicGameModels: [GameModel] {
    return [GameModel(id: 1, title: "A: 命令牌", description: "得到此牌的人，可以命令参与游戏的任何一人喝一杯酒。小游戏结束，此牌失效。"),
            ...
            GameModel(id: 6, title: "6：几棵柳树扭几扭", description: "依次向下顺着说，几棵柳树扭几扭。（举例说：拿到6的人可以说“3棵柳树扭3扭”，那么下一个人就说“4棵柳树扭4扭”），依次继续，谁说错或者卡住了谁喝一杯。小游戏结束，此牌失效。"),
            ...
            GameModel(id: 11, title: "J：左边喝", description: "得到此牌的人得左边的人喝。"),
